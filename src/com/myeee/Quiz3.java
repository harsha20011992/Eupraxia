...
TextView tv2; 
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.techquiz3);
		TextView tv1 = (TextView) findViewById(R.id.tvQuizCont1);
		tv2 = (TextView) findViewById(R.id.tvQuizCont2);
	...
	public void onClick(View v) {
		...
		if (v.getId() == R.id.tvQuizCont1 || v.getId() == R.id.tvQuizCont2) {
			
			AlertDialog alert = new AlertDialog.Builder(Quiz3.this)
					.create();
