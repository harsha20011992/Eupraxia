...
public class Treasure3 extends Activity implements OnClickListener{
TextView tv2; 
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.technicaltreasurehunt3);
		TextView tv1 = (TextView) findViewById(R.id.tvTreasureCont1);
		tv2 = (TextView) findViewById(R.id.tvTreasureCont2);
	...
	public void onClick(View v) {
		...
		if (v.getId() == R.id.tvTreasureCont1 || v.getId() == R.id.tvTreasureCont1) {
			
			AlertDialog alert = new AlertDialog.Builder(Treasure3.this)
					.create();
