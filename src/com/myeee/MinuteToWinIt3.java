...
public class MinuteToWinIt3 extends Activity implements OnClickListener{
TextView tv2; 
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.minute3);
		TextView tv1 = (TextView) findViewById(R.id.tvMinuteCont1);
		tv2 = (TextView) findViewById(R.id.tvMinuteCont2);
	...
	public void onClick(View v) {
		...
		if (v.getId() == R.id.tvMinuteCont1 || v.getId() == R.id.tvMinuteCont2) {
			
			AlertDialog alert = new AlertDialog.Builder(MinuteToWinIt3.this)
					.create();
	...
	public void onBackPressed() {
	  ...
	  clickedIntent.putExtra("activity","Minute");
