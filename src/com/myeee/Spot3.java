...
public class Spot3 extends Activity implements OnClickListener{
TextView tv2; 
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.spotevents3);
		TextView tv1 = (TextView) findViewById(R.id.tvSpotCont1);
		tv2 = (TextView) findViewById(R.id.tvSpotCont2);
	...
	public void onClick(View v) {
		...
		if (v.getId() == R.id.tvSpotCont1 || v.getId() == R.id.tvSpotCont2) {
			
			AlertDialog alert = new AlertDialog.Builder(Spot3.this)
					.create();
